...
static void serialize_u8(File* file, u8 bytes) {
...
static void serialize_string(File* file, const char* bytes) {
    u16 n = get_len(bytes);
...
static void serialize_constants(File* file, Program* program) {
...
static void serialize_interfaces(File* file, Program* program) {
...
static void serialize_fields(File* file, Program* program) {
...
static u16 get_constant_utf8_index(Program* program, const char* utf8) {
    for (u16 i = 1; i < program->constant_count; ++i) {
        Constant constant = program->constants[i - 1];
...
static void serialize_op(File* file, Op op) {
...
static void serialize_methods(File* file, Program* program) {
...
static void serialize_attributes(File* file, Program* program) {
